...
-(void) tick:(ccTime) dt {
    ...
    if ((woodchuckWalk.position.x < winSize.width) && (CGRectIntersectsRect(_tractorRect, _playerRect)))
    {
        ...
        int losses = [[NSUserDefaults standardUserDefaults] integerForKey:@"LevelTwoLosses"];
        losses++;
        [[NSUserDefaults standardUserDefaults] setInteger:losses forKey:@"LevelTwoLosses"];
