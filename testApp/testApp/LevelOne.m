	...
	if( (self=[super init])) {
		...
		if( UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone )
        {
            if (surface.width > 480)
            {
                ...
                background.position = ccp(winSize.width*0.25f, winSize.height*0.5f);
        ...
        // LEVEL LABEL
        CCLabelTTF *levelLabel = [CCLabelTTF labelWithString:@"Level 1" fontName:@"Helvetica" fontSize:24];
